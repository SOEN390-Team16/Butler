const getCondoRenters =
  ...
  'r.renterid, pu.userid FROM public_user pu, Renter r WHERE pu.userID = r.userID;'
const getCondoRenterById =
  'SELECT pu.first_name, pu.last_name, pu.email, pu.password, pu.profile_picture, pu.role,' +
  'r.renterid, pu.userid FROM public_user pu JOIN renter r ON pu.userid = r.userid WHERE r.renterid = $1;'
