...
const updateCondoDetails = "INSERT INTO condo_unit (propertyid, companyid, condo_number) VALUES ($1, $2, $3);";
const updateParkingDetails = "INSERT INTO parking_spot (propertyid, companyid, parking_number) VALUES ($1, $2, $3);";
const updateLockerDetails = "INSERT INTO locker (propertyid, companyid, locker_number) VALUES ($1, $2, $3);";
